...
import {TableBody, Table,TableHeaderColumn, TableRowColumn,TableRow, TableHeader} from 'material-ui/table';
...
const SIMPLE_TYPES = new Set(['boolean', 'string', 'number', 'date', 'double']);
